...
unsigned char Work_SheBei_id;
unsigned char ChuanKo_id;
unsigned char ChuanKo_id_send;
//int  R_ing;// 1: vga板正忙0:vga板空闲
//int  R_send_times;//记录重发次数
//int  R_send_wrong;//判断是否接受错误
int  R_red_write;// 0 是发送数据 只判断对错。1 是读数据取值
H_WIN  Gbutton_state_change;
extern void slider_thread();
