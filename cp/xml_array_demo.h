...
#ifndef H_XML_ONLYONE_DEMO_BENNIS_20131025
#define H_XML_ONLYONE_DEMO_BENNIS_20131025
...
typedef struct Array_Handle{
	char * toitemid;
	int    groupid;
	struct Array_Handle * next;
} array_handle;

extern void XML_Array_Handle_Date(int groupid,char * toitemid);
extern void Find_Array_Handle(int groupid);
extern void Find_Array_groupid(char * toitemid);
extern int Find_Array_groupnum(char * toitemid);
#endif
